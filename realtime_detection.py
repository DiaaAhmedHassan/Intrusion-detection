...
model.load_state_dict(torch.load("intrusion_model_weights.pth", map_location=torch.device('cpu')))
model.eval()
...
def extract_features(packet):
    try:
        ...
        return [length, proto, login_attempts, session_duration,
                encryption, reputation_score, failed_logins, browser, unusual_time, dummy]
    except:
        return None
